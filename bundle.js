...
/* harmony import */ var _models_destination_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/destination-model */ "./src/models/destination-model.js");
/* harmony import */ var _models_offer_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/offer-model */ "./src/models/offer-model.js");
...
class Api {
  ...
  getPoints() {
    ...
    .then((data) => {
      return _models_point_model__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints(data);
    });
  }
  ...
  getDestinations() {
    ...
    .then((response) => response.json())
    .then((data) => _models_destination_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseDestinations(data));
  }

  getOffers() {
    return this._load({url: `offers`})
    .then((response) => response.json())
    .then((data) => _models_offer_model__WEBPACK_IMPORTED_MODULE_2__["default"].parseOffers(data));
  }
  ...
  updatePoint(id, data) {
    ...
    .then((response) => response.json())
    .then((point) => {
      return _models_point_model__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(point);
    });
  }
...
/***/ "./src/components/day-component.js":
/*!*****************************************!*\
  !*** ./src/components/day-component.js ***!
  \*****************************************/
/*! exports provided: default */
...
const createDayTemplate = (count, date) => {
  ...
  date = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date(date).toISOString()); // если не перевести дату в ISO, то в консоль падает deprecation warning
...
class DayComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
/***/ "./src/components/day-list-component.js":
/*!**********************************************!*\
  !*** ./src/components/day-list-component.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DayListComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


const createDayListTemplate = () => `<ul class="trip-days"></ul>`;

class DayListComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
const createEventTypeMarkup = (eventType, destination) => {
  const typesList = Object.values(_constants__WEBPACK_IMPORTED_MODULE_2__["EventTypes"]).reduce((a, b) => a.concat(b));
...
const createDurationMarkup = (event) => {
  const duration = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(event);
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(dateFrom)}</time>
            &mdash;
            <time class="event__end-time">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(dateTo)}</time>
          </p>
...
class EventComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event) {
    super();
    this._event = event;
  }
...
/***/ "./src/components/event-edit-form-component.js":
/*!*****************************************************!*\
  !*** ./src/components/event-edit-form-component.js ***!
  \*****************************************************/
/*! exports provided: getOffersByType, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffersByType", function() { return getOffersByType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventEditFormComponent; });
...
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");
...
const createEventTypeMarkup = (types, currentType) => {
  ...
  const evtTypesMarkup = typesList.map((it) => createGroups(types[it], currentType, _constants_js__WEBPACK_IMPORTED_MODULE_4__["EventTypesGroups"][it])).join(`\n`);
...
const createEventDestinationMarkup = (eventType, destinations, destination) => {
  const typesList = Object.values(_constants_js__WEBPACK_IMPORTED_MODULE_4__["EventTypes"]).reduce((a, b) => a.concat(b));
  const typeDescription = typesList.find((it) => it.type === eventType).description;
...
const createAddEventFormTemplate = (event, destinations, allOffers, options = {}) => {
  ...
  const typeMarkup = createEventTypeMarkup(_constants_js__WEBPACK_IMPORTED_MODULE_4__["EventTypes"], type);
  ...
  const isAdding = mode === _constants_js__WEBPACK_IMPORTED_MODULE_4__["ViewMode"].ADD;
...
class EventEditFormComponent extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  _setCityInputChangeHandler() {
    ...
    cityInput.addEventListener(`change`, (evt) => {
      if (!evt.target.value) {
        ...
        this._city = he__WEBPACK_IMPORTED_MODULE_0___default.a.decode(evt.target.value);
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStart = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(startDateElement, {
      'altInput': true,
      'allowInput': true,
    ...
    this._flatpickrEnd = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(endDateElement, {
      'altInput': true,
      'allowInput': true,
...
/***/ "./src/components/no-points-component.js":
/*!***********************************************!*\
  !*** ./src/components/no-points-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
class NoPointsComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSortTemplate = (defaultType) => {
  const types = Object.values(_constants__WEBPACK_IMPORTED_MODULE_1__["SortType"]);
...
class SortComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._currentSortType = _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT;
    this._defaultSortType = _constants__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT;
  }
...
const TRANSPORT_TYPES = _constants__WEBPACK_IMPORTED_MODULE_3__["EventTypes"].transportGroup.map((it) => it.type);
...
const createTimeSpendChart = (ctx, events) => {
  ...
  events.forEach((event) => {
    if (timeData[event.type]) {
      timeData[event.type] += Math.round(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["getDuration"])(event).as(`hours`));
    } else {
      timeData[event.type] = Math.round(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["getDuration"])(event).as(`hours`));
    }
  });
...
/***/ "./src/components/trip-info-component.js":
/*!***********************************************!*\
  !*** ./src/components/trip-info-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
const createTripInfoTemplate = (events) => {
  ...
  startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(startDate);
  endDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(endDate);
...
class TripInfoComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: FilterType, SortType, ViewMode, EmptyEvent, EventTypes, EventTypesGroups */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventTypesGroups", function() { return EventTypesGroups; });
const FilterType = {
  ALL: `everything`,
  FUTURE: `future`,
  PAST: `past`
...
/* harmony import */ var _components_filter_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/filter-component */ "./src/components/filter-component.js");
...
class FilterController {
  constructor(container, pointsModel) {
    ...
    this._activeFilter = _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"]).map((filter) => {
      return {
        name: filter,
    ...
    this._filterComponent = new _components_filter_component__WEBPACK_IMPORTED_MODULE_1__["default"](filters);
    this._filterComponent.setFilterChangeHandler(this._onFilterChange);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(container, this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony import */ var _components_event_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event-component */ "./src/components/event-component.js");
/* harmony import */ var _components_event_edit_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/event-edit-form-component */ "./src/components/event-edit-form-component.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants */ "./src/constants.js");
/* harmony import */ var _models_point_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/point-model */ "./src/models/point-model.js");
...
const parseFormData = (event, offers, destinations, formData) => {
  ...
  const currentOffersByType = Object(_components_event_edit_form_component__WEBPACK_IMPORTED_MODULE_1__["getOffersByType"])(offers, type);
  const checkedOffers = currentOffersByType.filter((offer) => offersFromForm.includes(offer.title));

  return new _models_point_model__WEBPACK_IMPORTED_MODULE_4__["default"]({
    'id': event.id,
    'type': type,
...
class PointController {
  constructor(container, onDataChange, onViewChange, offers, destinations) {
    this._container = container;
    this._viewMode = _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].DEFAULT;
  ...
  render(event, viewMode = _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].DEFAULT) {
    this._viewMode = viewMode;
    const oldEventComponent = this._eventComponent;
    const oldEditEventComponent = this._editEventComponent;
    this._eventComponent = new _components_event_component__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._editEventComponent = new _components_event_edit_form_component__WEBPACK_IMPORTED_MODULE_1__["default"](event, viewMode, this._destinations, this._offers);
    ...
    this._editEventComponent.setFavoriteButtonClickHandler(() => {
      const newPoint = _models_point_model__WEBPACK_IMPORTED_MODULE_4__["default"].clone(event);
      newPoint.isFavorite = !newPoint.isFavorite;
      this._onDataChange(this, event, newPoint);
    });

    switch (viewMode) {
      case _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].DEFAULT:
        if (oldEventComponent && oldEditEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventComponent, oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._editEventComponent, oldEditEventComponent);
          this._replaceEditToEvent();
        } else {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(this._container, this._eventComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
        }
        break;
      case _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].ADD:
        if (oldEditEventComponent && oldEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldEditEventComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(this._container, this._editEventComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
        break;
    }
  }
  ...
  _replaceEventToEdit() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._editEventComponent, this._eventComponent);

    this._viewMode = _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].EDIT;
  }

  _replaceEditToEvent() {
    this._editEventComponent.reset();

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventComponent, this._editEventComponent);
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._editEventComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }

  setDefaultView() {
    if (this._viewMode !== _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].DEFAULT) {
      this._replaceEditToEvent();
    }
  }
  ...
  _onEscKeyDown(evt) {
    ...
    if (isEscPress) {
      if (this._viewMode === _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].ADD) {
        this._onDataChange(this, _constants__WEBPACK_IMPORTED_MODULE_3__["EmptyEvent"], null);
      }
      this._replaceEditToEvent();
    }
  }
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_day_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/day-component */ "./src/components/day-component.js");
/* harmony import */ var _point_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./point-controller */ "./src/controllers/point-controller.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants */ "./src/constants.js");
/* harmony import */ var _components_no_points_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-points-component */ "./src/components/no-points-component.js");
/* harmony import */ var _components_sort_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/sort-component */ "./src/components/sort-component.js");
...
const renderEvent = (container, event, onDataChange, onViewChange, destinations, offers) => {
  const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_2__["default"](container, onDataChange, onViewChange, offers, destinations);
...
const renderEvents = (container, events, onDataChange, onViewChange, destinations, offers) => {
  ...
  Array.from(dates).sort(getSortedDates).forEach((date, index) => {
    ...
    const day = new _components_day_component__WEBPACK_IMPORTED_MODULE_1__["default"](index + 1, date);
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(container, day, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  });
...
const renderSortEvents = (container, events, onDataChange, onViewChange, destinations, offers) => {
  const controllers = [];
  const day = new _components_day_component__WEBPACK_IMPORTED_MODULE_1__["default"]();
  const eventsList = day.getElement().querySelector(`.trip-events__list`);
...
class TripController {
  constructor(container, pointsModel, api, tripInfoComponent) {
    ...
    this._sortComponent = new _components_sort_component__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._noPointsComponent = new _components_no_points_component__WEBPACK_IMPORTED_MODULE_4__["default"]();

    this._tripInfoComponent = tripInfoComponent;

    this._sortType = _constants__WEBPACK_IMPORTED_MODULE_3__["SortType"].EVENT;
  ...
  render() {
    ...
    if (events.length > 0 || this._creatingPoint) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(container, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
    }

    if (isNoPointsExist) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(container, this._noPointsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }
  ...
  createPoint() {
    ...
    this._creatingPoint = new _point_controller__WEBPACK_IMPORTED_MODULE_2__["default"](container, this._onDataChange, this._onViewChange, this._pointsModel.getOffers(), this._pointsModel.getDestinations());
    this._creatingPoint.render(_constants__WEBPACK_IMPORTED_MODULE_3__["EmptyEvent"], _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].ADD);
  }
  ...
  _renderPoints() {
    ...
    switch (this._sortType) {
      case _constants__WEBPACK_IMPORTED_MODULE_3__["SortType"].EVENT:
        sortedPoints = this._pointsModel.getPoints();
        break;
      case _constants__WEBPACK_IMPORTED_MODULE_3__["SortType"].TIME:
        sortedPoints = this._pointsModel.getPoints().slice().sort((a, b) => Object(_utils_utils__WEBPACK_IMPORTED_MODULE_6__["getDuration"])(b) - Object(_utils_utils__WEBPACK_IMPORTED_MODULE_6__["getDuration"])(a));
        break;
      case _constants__WEBPACK_IMPORTED_MODULE_3__["SortType"].PRICE:
    ...
    if (this._sortType === _constants__WEBPACK_IMPORTED_MODULE_3__["SortType"].EVENT) {
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _constants__WEBPACK_IMPORTED_MODULE_3__["EmptyEvent"]) {
      this._creatingPoint = null;
      if (!newData) {
      ...
      this._api.updatePoint(oldData.id, newData)
        .then((pointModel) => {
          ...
          if (isSuccess) {
            pointController.render(newData, _constants__WEBPACK_IMPORTED_MODULE_3__["ViewMode"].DEFAULT);
            this._rerender();
          }
        })
        .catch(() => pointController.shake());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_api_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/api/api */ "./src/api/api.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_trip_info_component_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/trip-info-component.js */ "./src/components/trip-info-component.js");
/* harmony import */ var _components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/menu-component.js */ "./src/components/menu-component.js");
/* harmony import */ var _components_day_list_component_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/day-list-component.js */ "./src/components/day-list-component.js");
...
/* harmony import */ var _models_points_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/points-model */ "./src/models/points-model.js");
...
/* harmony import */ var _components_statistics_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/statistics-component */ "./src/components/statistics-component.js");
...
const api = new _src_api_api__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);

const pointsModel = new _models_points_model__WEBPACK_IMPORTED_MODULE_6__["default"]();

const pageMain = document.querySelector(`.page-main`);

const tripInfoContainer = document.querySelector(`.trip-main`);

const menuComponent = new _components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const tripControls = document.querySelector(`.trip-controls`);
const tripInfoComponent = new _components_trip_info_component_js__WEBPACK_IMPORTED_MODULE_2__["default"]();

const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_7__["default"](tripControls, pointsModel);
filterController.render();

Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(tripControls, menuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);

const daysListComponent = new _components_day_list_component_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const tripController = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_5__["default"](daysListComponent, pointsModel, api, tripInfoComponent);
const statisticsComponent = new _components_statistics_component__WEBPACK_IMPORTED_MODULE_8__["default"]({events: pointsModel});
...
Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(eventsContainer, daysListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(pageMain, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);

statisticsComponent.hide();

menuComponent.setOnClick((menuItem) => {
  switch (menuItem) {
    case _components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].TABLE:
      menuComponent.setActiveItem(_components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].TABLE);
      statisticsComponent.hide();
      tripController.show();
      filterController.show();
      break;
    case _components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].STATISTIC:
      menuComponent.setActiveItem(_components_menu_component_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].STATISTIC);
      tripController.hide();
...
api.getPoints()
  .then((points) => {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(tripInfoContainer, tripInfoComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DestinationModel; });
class DestinationModel {
  constructor(data) {
    this.description = data[`description`];
    this.name = data[`name`];
    this.pictures = Array.from(data[`pictures`]);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return OfferModel; });
class OfferModel {
  constructor(data) {
    this.type = data[`type`];
...
class PointsModel {
  ...
  getPoints() {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_1__["getEventsByFilter"])(this._points, this._activeFilter);
  }
...
const getEventsByFilter = (events, filter) => {
  const now = Date.now();

  switch (filter) {
    case _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL:
      return events;
    case _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE:
      return getFutureEvents(events, now);
    case _constants__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST:
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: getDuration, formatTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getDuration = (event) => {
  const start = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.dateFrom);
  const end = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.dateTo);
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(end.diff(start));
};
